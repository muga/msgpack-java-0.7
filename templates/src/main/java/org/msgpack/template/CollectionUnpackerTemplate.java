...
public class CollectionUnpackerTemplate<E> extends
		AbstractUnpackerTemplate<Collection<E>> {
	private UnpackerTemplate<E> elementUnpackerTemplate;

	public CollectionUnpackerTemplate(
			UnpackerTemplate<E> elementUnpackerTemplate) {
