...
public class LongArrayTemplate extends AbstractCommonTemplate<long[]> {
	private LongArrayTemplate() {
	}

	public void write(Packer packer, long[] target, boolean required)
			throws IOException {
		if (target == null) {
			if (required) {
	...
	public long[] read(Unpacker unpacker, long[] to, boolean required)
			throws IOException {
